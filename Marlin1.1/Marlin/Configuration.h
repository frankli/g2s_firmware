...
#define STRING_CONFIG_H_AUTHOR "(Frank Li, Delta)" // Who made the changes.
...
#define HOTEND_OFFSET_X {0.0, 0.375} // (in mm) for each extruder, offset of the hotend on the X axis
#define HOTEND_OFFSET_Y {0.0, 26.1}  // (in mm) for each extruder, offset of the hotend on the Y axis
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 226.68
  #define  DEFAULT_bedKi 41.92
  #define  DEFAULT_bedKd 306.42
...
#define DELTA
  ...
  #define DELTA_HEIGHT 202.15 // get this value from auto calibrate - use G33 C-1 at 1st time calibration
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -4.75  // Z offset: -below +above  [the nozzle]
