...
#define HOTEND_OFFSET_Y {-13.0, 13.1}  // (in mm) for each extruder, offset of the hotend on the Y axis
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 93, 93}  // default steps per unit for Kossel (GT2, 20 tooth)
